...
#define pinReceptor 0
#define Pecho 9 //ULTRASONIDO
#define Ptrig 10 //ULTRASONIDO
#define correcto 12 //LED DE VERIFICACION
#define incorrecto 13 //LED DE VERIFICACION
...
int estadoBoton = LOW; //Variable que usaremos para detectar q halla una sesion iniciada
void setup(){
...
void loop(){
  ...
  if(distancia>=10 && distancia<=30){
    ...
    estadoBoton = digitalRead(pinReceptor);
    if(estadoBoton == HIGH){
      captureImg(320, 240);
    }
  }
